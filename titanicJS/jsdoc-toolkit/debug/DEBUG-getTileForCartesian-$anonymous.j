...
<fires> []
<desc> []
<alias> [getTileForCartesian-$anonymous.j]
<id> [3399]
<isStatic> [false]
<see> []
<methods> []
...
<srcFile> [../../timestep/timestep/IsometricTiledView.js]
<exceptions> []
<isa> [OBJECT]
<_name> [getTileForCartesian-$anonymous.j]
<_params> []
<deprecated> []
<requires> []
<author> []
...
<example> []
<properties> []
<name> [getTileForCartesian-$anonymous.j]
<getEvents> [
function () {
    var events = [];

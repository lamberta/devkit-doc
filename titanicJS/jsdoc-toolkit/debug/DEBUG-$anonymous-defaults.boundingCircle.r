...
<fires> []
<desc> []
<alias> [$anonymous-defaults.boundingCircle.r]
<id> [3173]
<isStatic> [false]
<see> []
<methods> []
...
<srcFile> [../../timestep/timestep/IsoCharacterView.js]
<exceptions> []
<isa> [OBJECT]
<_name> [$anonymous-defaults.boundingCircle.r]
<_params> []
<deprecated> []
<requires> []
<author> []
...
<example> []
<properties> []
<name> [$anonymous-defaults.boundingCircle.r]
<getEvents> [
function () {
    var events = [];

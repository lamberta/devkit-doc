...
<fires> []
<desc> []
<alias> [_getStaticViewGridPosition-$anonymous.y]
<id> [5417]
<isStatic> [false]
<see> []
<methods> []
...
<srcFile> [../../timestep/timestep/tiled/TiledMapScrollView.js]
<exceptions> []
<isa> [OBJECT]
<_name> [_getStaticViewGridPosition-$anonymous.y]
<_params> []
<deprecated> []
<requires> []
<author> []
...
<example> []
<properties> []
<name> [_getStaticViewGridPosition-$anonymous.y]
<getEvents> [
function () {
    var events = [];
